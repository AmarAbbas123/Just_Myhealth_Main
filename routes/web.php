...
use App\Http\Controllers\Modules\Mod10ProfessionalServices\Counselling01\Patients\PatientsIssuesConcernsController;
...
//Reporting login-history-90days
Route::middleware(['auth', 'usertype:admins'])->group(function () {
    Route::get('/mod-02/user-reports/login-history-90days', [LoginHistory90DaysController::class, 'index'])->name('reports.login.history');
...
->group(function () {
    ...
    ->group(function () {
        ...
        Route::get('mod-10/mb/my-collateral-documents/download/{type}/{folder}/{file}', 'download')->name('collateral.download');
        Route::delete('mod-10/mb/my-collateral-documents/delete/{type}/{folder}/{file}', 'delete')->name('collateral.delete');
    });
...
Route::controller(UsrPreviousTherapistsController::class)
    ...
    Route::controller(PatientsIssuesConcernsController::class)
    ->middleware(['auth', 'usertype:user'])
    ->group(function () {
