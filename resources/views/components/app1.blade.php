<!-- resources\views\components\app1.blade.php   DASHBOARD MIAN THEME -->
<!DOCTYPE html>
...
<body class="antialiased text-gray-900 overflow-x-hidden" x-data="{ isSidebarOpen: true, isSideMenuOpen: false }">
