    ...
    <main class="pt-20 min-h-screen">
        ...
        <section class="relative flex h-56 items-end sm:h-64 sm:items-center lg:h-80">
            ...
            <div class="w-full max-w-4xl px-5 pb-6 sm:px-8 sm:pb-0 lg:px-20">
                ...
                <!-- Breadcrumb -->
                <div class="inline-flex max-w-full items-top gap-2 rounded-full bg-white/10 px-4 py-1.5 text-xs font-medium text-white/90 shadow-lg backdrop-blur-md sm:px-5 sm:py-2 sm:text-base">
