...
<x-app-layout>
    ...
    {{--
        Shared "info row" pattern used for every section below:
        eyebrow badge + heading on the left, a quiet intro line under it,
        and an accent-bordered content card on the right.
        Background alternates white / soft teal tint so five stacked
        sections don't visually merge into one long wall, and the
        grid order alternates left/right so the page has a gentle rhythm
        instead of repeating the exact same block five times.
    --}}
        ...
        <div class="container mx-auto px-6 lg:px-12">
            <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                <div>
                    ...
                    <h2 class="max-w-xl text-3xl font-semibold leading-tight text-[#102f3a] sm:text-4xl">
                ...
                <div class="rounded-2xl border-l-4 border-[#0f89a6] bg-white py-6 pl-6 pr-6 shadow-[0_24px_70px_-55px_rgba(16,106,124,0.65)] md:pl-8">
    ...
    <section class="bg-gradient-to-b from-[#f4fbfb] to-[#eef8f7] py-14 md:py-20">
        <div class="container mx-auto px-6 lg:px-12">
            <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                <div>
                    <p class="mb-5 inline-flex rounded-full border border-[#9ed9d7] bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-[#0f89a6] shadow-sm">
    ...
    <!-- Section 3: Your Counsellor, Matched to Your Needs -->
    <section class="bg-white py-14 md:py-20">
        <div class="container mx-auto px-6 lg:px-12">
            <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                <div class="rounded-2xl border-l-4 border-[#0f89a6] bg-white py-6 pl-6 pr-6 shadow-[0_24px_70px_-55px_rgba(16,106,124,0.65)] md:pl-8 lg:order-1">
                    <div class="space-y-5 text-base leading-8 text-[#243b45] md:text-lg">
                        <p class="font-medium text-[#102f3a]">
    ...
    <!-- Section 4: A Safe, Confidential Space -->
    <section class="bg-gradient-to-b from-[#f4fbfb] to-[#eef8f7] py-14 md:py-20">
        <div class="container mx-auto px-6 lg:px-12">
            <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                <div>
                ...
                <div class="rounded-2xl border-l-4 border-[#0f89a6] bg-white py-6 pl-6 pr-6 shadow-[0_24px_70px_-55px_rgba(16,106,124,0.65)] md:pl-8">
                    <div class="text-base leading-8 text-[#243b45] md:text-lg">
                        <p class="font-medium text-[#102f3a]">
    ...
    <!-- Section 5: Support That Fits Your Life -->
    <section class="bg-white py-14 md:py-20">
        <div class="container mx-auto px-6 lg:px-12">
            <div class="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                <div class="rounded-2xl border-l-4 border-[#0f89a6] bg-white py-6 pl-6 pr-6 shadow-[0_24px_70px_-55px_rgba(16,106,124,0.65)] md:pl-8 lg:order-1">
    ...
    <div class="bg-white">
        ...
        <div class="container mx-auto px-6 lg:px-12">
            <p class="max-w-4xl mx-auto text-center text-base leading-7 text-[#4b626b] pt-14 md:pt-20">
        ...
        {{-- Pricing --}}
        <section class="w-full bg-gradient-to-b from-[#f0fbfa] to-[#e8f8f7] py-16 px-6 lg:px-12 mt-14 md:mt-20">
            <div class="max-w-6xl mx-auto">
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-[#1C9BA0]">Investment in Your Wellbeing</p>
                <h2 class="mt-3 mb-10 text-3xl font-semibold leading-tight text-[#102f3a] sm:text-4xl">Counselling Process &amp; Cost</h2>
            ...
            <div class="container mx-auto px-6 lg:px-12">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
                    ...
                    <div>
                        ...
                        <h2 class="mt-3 mb-5 text-3xl font-semibold leading-tight text-[#102f3a] sm:text-4xl">Engage and Benefit</h2>
