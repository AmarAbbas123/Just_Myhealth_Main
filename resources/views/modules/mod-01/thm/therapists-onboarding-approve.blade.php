<x-app1scrollxtable>
    ...
    <div class="px-6 mx-auto mt-6" x-data="therapistsApproval()">
                    ...
                    @empty
                        <tr>
                            <td class="px-3 py-6 text-center text-gray-500" colspan="7">
                                No therapists awaiting approval.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <div x-show="isStatusOpen" x-cloak class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4"
            ...
            <div class="bg-white rounded-xl w-full max-w-lg p-6 shadow-xl" @click.stop>
                ...
                <form method="POST" :action="statusActionUrl()" class="mt-4 space-y-3">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Approver notes (max 128 chars)</label>
                        <input
                            type="text"
                            name="approver_notes"
                        ...
                        <div class="mt-1 text-xs text-gray-500 text-right">
                            <span x-text="approverNotes.length"></span>/128
                        </div>
                    </div>
